...
function Result() {
  ...
  const [res, setRes] = useState("")
    ...
    function result() {
        ...
        else if ((choice === "rock" && rand === "scissors") || (choice === "paper" && rand === "rock") || (choice === "scissors" && rand === "paper")) 
        {
            return "win"
        }
        else {
  ...
  return (
    <div className='result-container-dsk'>
        ...
        <div className='result-section'>
            <div className='the-result upper show-res'>{res === "win" ? "You win" : res === "loss" ? "You lose" : "draw"}</div>
            <div className={classNames('result-button upper',{
                "red" : res === "loss",
            })} onClick={() => setShowR(false)}>Play again</div>
        </div>
